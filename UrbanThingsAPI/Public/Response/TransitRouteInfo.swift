...
/// Provides data for a transit route.
///
/// Inherited by `TransitDetailedRouteInfo`
public protocol TransitRouteInfo {
    ...
    /// Location of the geographical centre point of this route, (based on analysing the route's longest trips in each direction). This may be used to aid in sorting routes by proximity, optional.
